            ...
            {activeTab === 'student' && (
              <div className="space-y-6 animate-fade-in py-2">
                <div className="text-center space-y-2 mb-8">
                  ...
                  <h3 className="text-white font-medium text-lg">Student Portal</h3>
                  <p className="text-slate-400 text-sm">Please sign in with your official university Google account (@sguk.ac.in) to access your dashboard.</p>
                </div>

                <button
                  type="button"
                  onClick={() => handleGoogleLogin()}
                  className="w-full h-12 bg-white hover:bg-slate-100 text-slate-800 text-[15px] font-semibold rounded-xl flex items-center justify-center gap-3 transition-all focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-900 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)] disabled:opacity-70 disabled:cursor-not-allowed"
                  disabled={isLoading}
                >
                  {isLoading ? (
                    <>
