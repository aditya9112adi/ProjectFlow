    ...
    <div className="h-screen relative flex overflow-hidden bg-slate-950">
      ...
      <div className="absolute top-6 left-6 lg:top-10 lg:left-12 z-20 flex items-center gap-4">
        <img 
          src="/niat-brand.png" 
          alt="NIAT Brand" 
          className="h-14 lg:h-16 w-auto object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]" 
          style={{ filter: 'brightness(0) invert(1)' }}
        />
        <span className="text-white font-black text-2xl lg:text-3xl uppercase tracking-wider drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">Kolhapur</span>
      </div>
          ...
          {activeTab === 'student' && (
            <form onSubmit={handleStudentSubmit(onStudentSubmit)} className="space-y-5 animate-fade-in">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 text-base gap-2 mt-4 bg-cyan-600 hover:bg-cyan-500 text-white font-bold rounded-xl flex items-center justify-center transition-all shadow-[0_0_20px_rgba(6,182,212,0.2)] focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-slate-900"
              >
                {isLoading ? (
                  <>
          ...
          {activeTab === 'admin' && (
            <form onSubmit={handleAdminSubmit(onAdminSubmit)} className="space-y-5 animate-fade-in">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 text-base gap-2 mt-4 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl flex items-center justify-center transition-all shadow-[0_0_20px_rgba(16,185,129,0.2)] focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-900"
              >
                {isLoading ? (
                  <>
                    <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
